...
$form_generator_array = [
    ...
    'build' => [
         ...
         */
        'input-types' => [
            // default: FormGenerator_namespace\SpiderFormInputTypes
            // if you set your namespace the system will run your SpiderFormInputTypes folder
            // only name space your folder name must be SpiderFormInputTypes
            'namespace' => ''
        ],
        /**
         * optional
         */
        'build-object' => [
            // default: FormGenerator_namespace\SpiderFormBuilder
            // if you set your namespace the system will run your SpiderFormBuilder folder
            // only name space your folder name must be SpiderFormBuilder
            'namespace' => ''
        ],
    ],
