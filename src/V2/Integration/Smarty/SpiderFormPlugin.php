 ...
 * $smarty->registerPlugin('function', 'form_start', ['SpiderFormPlugin', 'formStart']);
 * $smarty->registerPlugin('function', 'form_text', ['SpiderFormPlugin', 'formText']);
 * $smarty->registerPlugin('function', 'form_end', ['SpiderFormPlugin', 'formEnd']);
 * 
...
class SpiderFormPlugin
{
    ...
    public static function formStart(array $params, $smarty): string
    {
        ...
        if (self::$renderer === null) {
            throw new \RuntimeException('Renderer not set. Call SpiderFormPlugin::setRenderer() first.');
        }
